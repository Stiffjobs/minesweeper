...
class Sentence():
    ...
    def mark_mine(self, cell): #update knowledge
        """
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        #making new knowledge using the old one.
        for i, sentence1 in enumerate(self.knowledge):
            for j, sentence2 in enumerate(self.knowledge):
                ...
                if sentence1.cells.issubset(sentence2.cells):
                    ...
                    sentence2.count = max(0, sentence2.count - sentence1.count)
                elif sentence2.cells.issubset(sentence1.cells):
                    sentence1.cells = sentence1.cells - sentence2.cells
                    sentence1.count = max(0, sentence1.count - sentence2.count)
                    
        #making new conclusion by new knowledge
        for sentence in self.knowledge:
